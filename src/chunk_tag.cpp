...
generic_tag* chunk_tag::copy_tag(generic_tag* src) {
    ...
    switch (src->type) {
        ...
        case generic_tag::BYTE:
            tag = copy_tag_helper<byte_tag>(src);
            break;
        case generic_tag::SHORT:
            tag = copy_tag_helper<short_tag>(src);
            break;
        case generic_tag::INT:
            tag = copy_tag_helper<int_tag>(src);
            break;
        case generic_tag::LONG:
            tag = copy_tag_helper<long_tag>(src);
            break;
        case generic_tag::FLOAT:
            tag = copy_tag_helper<float_tag>(src);
            break;
        case generic_tag::DOUBLE:
            tag = copy_tag_helper<double_tag>(src);
            break;
        case generic_tag::BYTE_ARRAY:
            tag = copy_tag_helper<byte_array_tag>(src);
            break;
        case generic_tag::STRING:
            tag = copy_tag_helper<string_tag>(src);
            break;
        case generic_tag::INT_ARRAY:
            tag = copy_tag_helper<int_array_tag>(src);
            break;
    }
    return tag;
}
